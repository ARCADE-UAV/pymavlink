...
class MAVLink_param_request_read_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 1, struct.pack('<hBB64s', self.param_index, self.target_system, self.target_component, self.param_id))
...
class MAVLink_param_value_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 76, struct.pack('<fHH64sB', self.param_value, self.param_count, self.param_index, self.param_id, self.param_type))
...
class MAVLink_param_set_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 56, struct.pack('<fBB64sB', self.param_value, self.target_system, self.target_component, self.param_id, self.param_type))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_PARAM_REQUEST_READ : ( '<hBB64s', MAVLink_param_request_read_message, [1, 2, 3, 0], 1 ),
        MAVLINK_MSG_ID_PARAM_REQUEST_LIST : ( '<BB', MAVLink_param_request_list_message, [0, 1], 159 ),
        MAVLINK_MSG_ID_PARAM_VALUE : ( '<fHH64sB', MAVLink_param_value_message, [3, 0, 4, 1, 2], 76 ),
        MAVLINK_MSG_ID_PARAM_SET : ( '<fBB64sB', MAVLink_param_set_message, [1, 2, 3, 0, 4], 56 ),
