...
class MAVLink_data_transmission_handshake_message(MAVLink_message):
        ...
        def pack(self, mav):
                return MAVLink_message.pack(self, mav, 148, struct.pack('<IBBBB', self.size, self.type, self.packets, self.payload, self.jpg_quality))
...
mavlink_map = {
        ...
        MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE : ( '<IBBBB', MAVLink_data_transmission_handshake_message, [1, 0, 2, 3, 4], 148 ),
...
class MAVLink(object):
        ...
        def param_value_encode(self, param_id, param_value, param_type, param_count, param_index):
                ...
                param_type                : Onboard parameter type: see MAVLINK_TYPE_* in generated code (uint8_t)
